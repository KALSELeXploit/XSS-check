...
'''
    ...
    ----------------------------------------------------------
    2)Intensive Scan -> [Scan all links in the page that doesnt directed to the outside of the site.]
    ---------------------------------------------------------
    3)Quick Scan -> [Scan only given url.] {USING TOR}
    ----------------------------------------------------------
    4)Intensive Scan -> [Scan all links in the page that doesnt directed to the outside of the site.] {USING TOR}
    ---------------------------------------------------------
    5)Get all links in the page that doesnt directed to the outside of the site
    ----------------------------------------------------------
    6)How many forms in the url -> [Scan all links in the page that doesnt directed to the outside of the site.]
    ----------------------------------------------------------
    7)Get the input box
    '''
    try:
